...
# 정리
# 오늘 꼭 알아야 하는 리스트 값 추가 수정 메서드와 개념
# 리스트 수정하는 메서드 (3가지)
# .append(추가할 값) : 리스트 가장 마지막에 값을 추가해 줌
# .insert(위치, 값) : 첫 번째 인자인 위치 인덱스에 값을 삽입해 줌
# .extend(합칠리스트) : 두 리스트를 하나의 리스트로 합체
# 위 3가지 메서드들은 원본 리스트 자체를 수정함


# ------------------------------------------------------------------------------------

# 리스트에서 요소 삭제
# .remove(값) : 위치는 모르고 삭제할 "값"만 알 떄 사용하는 요소 삭제 메서드
# .pop(인덱스) : 인덱스로 특정 요소를 삭제할 떄 사용 ->>> 삭제한 인덱스의 값을 반환
...
list2 = ["딸기", "사과", "배", "포도", "수박", "망고"]
list2.remove("수박")
print(list2)  # ['딸기', '사과', '배', '포도', '망고']
...
list2.pop(0)  # ['사과', '배', '포도', '망고']  # "딸기 지워짐"
# pop 메서드는 삭제한 인덱스 값을 반환해준다는 것을 설명하는 용도
print(list2.pop(2))  # 삭제한 인덱스 2번의 값인 포도를 출력 # 포도 출력됨
# 삭제도 하고, 삭제한 인덱스 값도 출력해 줌
print(list2)  # ['사과', '배', '망고']
...
n = [37, 2, 8, 100, 10004, -1, 22]

# 오름차순 정렬
n.sort()  # 원본 리스트 수정
print(
    "n 리스트 오름차순 정렬 결과 : ", n
)  # n 리스트 오름차순 정렬 결과 :  [-1, 2, 8, 22, 37, 100, 10004]

# 내림차순 정렬
n.sort(reverse=True)
print(
    "n 리스트 내림차순 정렬 결과 :", n
)  # n 리스트 내림차순 정렬 결과 : [10004, 100, 37, 22, 8, 2, -1]

# 리스트 순서 뒤집기
# .reverse()
# 값의 크기대로 정렬은 해주지 않음
# 뒤로 계속 쌓인 결과(최신)를 앞에서부터 보고싶을 떄 사용

n = [37, 2, 8, 100, 10004, -1, 22]
print("n 리스트 원본 :", n)  # n 리스트 원본 : [37, 2, 8, 100, 10004, -1, 22]

n.reverse()
print(
    "n 리스트 순서 뒤집기 결과 :", n
)  # n 리스트 순서 뒤집기 결과 : [22, -1, 10004, 100, 8, 2, 37]
...
if weather == "비":
    ...
    print("따뜻한 장갑을 끼고 나가세요! 🧤")
elif weather == "맑음":
    print("산책하기 좋은 날씨네요! ☀️")
else:
    print("안전하고 좋은 하루 보내세요!")
...
# 조건에 따라 결과 출력하기
if score >= 90:
    print("수고하셨습니다! A 학점입니다. 🎉")
elif score >= 80:
    print("잘하셨습니다! B 학점입니다. 👍")
elif score >= 70:
    print("노력하셨네요! C 학점입니다. 🙂")
else:
    print("조금 더 분발하세요! F 학점입니다. 😢")