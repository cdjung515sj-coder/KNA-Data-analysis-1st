...
if temp > 80:
  print("경고") 
print("정상")  # if문 밖의 코드는 무조건 실행됨 => 이 경우에는 temp 변수의 값이 80이 넘으면 실행됨.. => 원하는 동작이 아님에도 불구하고 실행이 돼,,,,,,,,,,,,,
...
user_1 = float(input("체온을 입력해주세요. :"))

if user_1 >= 36.2 and user_1 <= 36.9:
    print("당신은 정상체온입니다.")
else:
   if user_1 > 36.9:
...
# 위의 체온 판단 if문 안에서 열나는지 저체온인지 판단하도록 수정해줭
